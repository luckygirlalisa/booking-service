...
import com.rennixing.order.model.OrderAcceptFulfilment
import com.rennixing.order.model.OrderCancellationFulfilment
import com.rennixing.order.model.OrderItem
import com.rennixing.order.model.OrderState
import com.rennixing.order.model.PaymentFulfilment
import com.rennixing.order.model.PrepareMealFulfilment
...
val orderPendingCancellationConfirmation = Order(
    ...
    orderCancellationFulfilment = OrderCancellationFulfilment(
        createAt = "2021-09-12 00:20:00",
        expireAt = "2021-09-12 00:25:00",
        fulfilledAt = null
    )
)
